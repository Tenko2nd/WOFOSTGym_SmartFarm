...
class Perennial_Limited_NPKW_Env(NPK_Env, LNPKW):
...
class Perennial_PP_Env(NPK_Env, PP):
...
class Perennial_Limited_NPK_Env(NPK_Env, LNPK):
...
class Perennial_Limited_N_Env(NPK_Env, LN):
...
class Perennial_Limited_NW_Env(NPK_Env, LNW):
...
class Perennial_Limited_W_Env(NPK_Env, LW):
...
class Perennial_Limited_Layered_NPKW_Env(NPK_Env, LNPKW):
...
class Perennial_Layered_PP_Env(NPK_Env, PP):
    """Simulates Potential Production. That is how much the crop would grow
...
class Perennial_Limited_Layered_NPK_Env(NPK_Env, LNPK):
...
class Perennial_Limited_Layered_N_Env(NPK_Env, LN):
...
class Perennial_Limited_Layered_NW_Env(NPK_Env, LNW):
...
class Perennial_Limited_Layered_W_Env(NPK_Env, LW):
