...
class Plant_Limited_NPKW_Env(Plant_NPK_Env, LNPKW):
...
class Plant_PP_Env(Plant_NPK_Env, PP):
...
class Plant_Limited_NPK_Env(Plant_NPK_Env, LNPK):
...
class Plant_Limited_N_Env(Plant_NPK_Env, LN):
...
class Plant_Limited_NW_Env(Plant_NPK_Env, LNW):
...
class Plant_Limited_W_Env(Plant_NPK_Env, LW):
...
class Plant_Limited_Layered_NPKW_Env(Plant_NPK_Env, LNPKW):
    """Simulates crop growth under NPK and Water Limited Production
...
class Plant_Layered_PP_Env(Plant_NPK_Env, PP):
    """Simulates crop growth under abundant NPK and water
    with actions for planting and harvesting with layered water balance
    """
...
class Plant_Limited_Layered_NPK_Env(Plant_NPK_Env, LNPK):
    """Simulates crop growth under NPK Limited Production
    with actions for planting and harvesting with layered water balance
    """
...
class Plant_Limited_Layered_N_Env(Plant_NPK_Env, LN):
    """Simulates crop growth under Nitrogen Limited Production
    with actions for planting and harvesting with layered water balance
    """
...
class Plant_Limited_Layered_NW_Env(Plant_NPK_Env, LNW):
    """Simulates crop growth under Nitrogen and Water Limited Production
    with actions for planting and harvesting with layered water balance
    """
...
class Plant_Limited_Layered_W_Env(Plant_NPK_Env, LW):
    """Simulates crop growth under Water Limited Production
    with actions for planting and harvesting with layered water balance
    """
