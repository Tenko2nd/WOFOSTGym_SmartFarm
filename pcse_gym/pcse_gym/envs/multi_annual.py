...
Used for single-year multi-farm annual crop simulations.
...
class Multi_Limited_NPKW_Env(Multi_NPK_Env, LNPKW):
...
class Multi_PP_Env(Multi_NPK_Env, PP):
...
class Multi_Limited_NPK_Env(Multi_NPK_Env, LNPK):
...
class Multi_Limited_N_Env(Multi_NPK_Env, LN):
...
class Multi_Limited_NW_Env(Multi_NPK_Env, LNW):
...
class Multi_Limited_W_Env(Multi_NPK_Env, LW):
...
class Multi_Limited_Layered_NPKW_Env(Multi_NPK_Env, LNPKW):
...
class Multi_Layered_PP_Env(Multi_NPK_Env, PP):
    """Simulates Potential Production. That is how much the crop would grow
...
class Multi_Limited_Layered_NPK_Env(Multi_NPK_Env, LNPK):
...
class Multi_Limited_Layered_N_Env(Multi_NPK_Env, LN):
...
class Multi_Limited_Layered_NW_Env(Multi_NPK_Env, LNW):
...
class Multi_Limited_Layered_W_Env(Multi_NPK_Env, LW):
